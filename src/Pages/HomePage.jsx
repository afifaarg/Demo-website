...
import productsData from "../components/products.json"; // Adjust the path as necessary
      ...
      <div className="mt-2 mb-10  overflow-hidden bg-neutral-100" id="products">
        ...
        <div className="py-4 border-primary-dark flex flex-col justify-center mx-12 items-center">
          ...
          <p className="max-w-4xl text-center">
            ...
            produits innovants et tendance, soigneusement choisis pour répondre
            à vos envies. Ne manquez pas ces nouveautés !
          </p>
        </div>
